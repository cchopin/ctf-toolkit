# Markup - Write-up HackTheBox

![HTB Markup](https://img.shields.io/badge/HackTheBox-Markup-green)![Difficulty](https://img.shields.io/badge/Difficulty-Easy-yellow)![OS](https://img.shields.io/badge/OS-Windows-blue)
...
|---------------|-------------|-------------|
| **Credentials par défaut** | Login admin:password | Forcer le changement de mot de passe à la première connexion |
