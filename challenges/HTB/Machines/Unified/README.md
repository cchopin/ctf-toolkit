# Unified - Write-up HackTheBox

![HTB Unified](https://img.shields.io/badge/HackTheBox-Unified-green)![Difficulty](https://img.shields.io/badge/Difficulty-Very%20Easy-brightgreen)![OS](https://img.shields.io/badge/OS-Linux-blue)
...
Les captures Wireshark montrent le callback LDAP de la cible vers l'attaquant :

![TCP SYN - Callback LDAP](1.png)
*Paquet TCP SYN de la cible vers l'attaquant sur le port 389*

![TCP RST ACK](2.png)
*Détails du paquet TCP*

![Détails TCP](3.png)
*Informations détaillées du paquet SYN*
